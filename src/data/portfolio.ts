...
export const profile = {
  ...
  location: "Noida, Uttar Pradesh 201301, India",
  phone: "+91-8178223608",
  ...
  resume: "/raj-kumar-tiwari-resume.html",
  summary:
    "Full Stack Developer with 2.5+ years of experience designing and shipping responsive, high-performance web applications using React.js, Next.js, JavaScript, TypeScript, Redux, and Material UI, backed by Node.js, Express.js, and MongoDB. Proven record of turning complex requirements into scalable architecture and measurable performance gains, with intermediate expertise in Data Structures & Algorithms and C++, strong proficiency with MongoDB, and hands-on experience delivering production AI features through RAG, LangChain, and OpenAI integration.",
};
...
export const projects: Project[] = [
  {
    title: "AI Agent with Retrieval-Augmented Generation (RAG)",
    category: "ai",
    summary:
    ...
    highlights: [
      ...
      "Created a custom retriever tool and enabled dynamic tool selection through a tool-calling agent architecture, with ChatOllama (Llama 3.1) as the core model.",
